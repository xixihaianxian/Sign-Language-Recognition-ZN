...
def main():
    ...
    # 数据原始位置
    parser.add_argument("--origin","-o",type=str,help="data origin path",default="./CE-CSL/video",dest="origin_data_path")
    # 存放预处理后数据的位置
    parser.add_argument("--save","-s",type=str,help="data save path",default="./data/video",dest="save_path")
    # 获取所有的参数
